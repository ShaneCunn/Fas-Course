...
public class Examples {
	...
	static void logicalOperator() {
		...
		/*
		 * && is AND have both have to be true || is OR either can be true ! is
		 * NOT
		 *
		 *
		 */
		...
		/*
		 * && are called short circuit operators , if the first part evalautes
		 * to false , it does not bother with the second or subsequent ones
		 */

		/*
		 * & ensure both sisdes are evaluated and are impletmented, even if the
		 * first argument is false, so here is incremetneted by one
		 *
		 *
		 */
